...
DATABASE = os.path.join(INSTANCE_DIR, "bisu_lostnfound.db")
LOGO_PATH = os.path.join(BASE_DIR, "bisu_logo.png")
UPLOAD_DIR = os.path.join(BASE_DIR, "uploads")
ALLOWED_EXTENSIONS = {"png", "jpg", "jpeg", "gif", "webp"}

app = Flask(__name__)
app.config["SECRET_KEY"] = os.environ.get("SECRET_KEY", "bisu-lostnfound-secret-key")
